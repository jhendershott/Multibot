...
namespace multicorp_bot
{
    public class Ranks
    {
        ...
        public List<Rank> CommerceRanks { get; set; } = new List<Rank>()
        {
            ...
            new Rank () { RankName = "Associate III", Abbreviation = "3ASSC", Number = 26 },
            new Rank () { RankName = "Senior Associate", Abbreviation = "SASSC", Number = 27 },
            new Rank () { RankName = "Specialist I", Abbreviation = "SPC", Number = 28 },
            new Rank () { RankName = "Specialist II", Abbreviation = "SPC2", Number = 29 },
            new Rank () { RankName = "Specialist III", Abbreviation = "SPC3", Number = 30 },
            new Rank () { RankName = "Operator I", Abbreviation = "Operator", Number = 31 },
            new Rank () { RankName = "Operator II", Abbreviation = "Operator II", Number = 32 },
            new Rank () { RankName = "Operator III", Abbreviation = "Operator III", Number = 33 },
            new Rank () { RankName = "Principal", Abbreviation = "Principal", Number = 34 },
            new Rank () { RankName = "Partner", Abbreviation = "Partner", Number = 35 },
            new Rank () { RankName = "Manager", Abbreviation = "MGR", Number = 36 },
            new Rank () { RankName = "Senior Manager", Abbreviation = "SMGR", Number = 37 },
            new Rank () { RankName = "Staff Manager", Abbreviation = "STMGR", Number = 38 },
            new Rank () { RankName = "Supervisor", Abbreviation = "SUP", Number = 39 },
            new Rank () { RankName = "Director", Abbreviation = "DIR", Number = 40 },
            new Rank () { RankName = "Senior Director", Abbreviation = "SDIR", Number = 41 },
            new Rank () { RankName = "Department Admin", Abbreviation = "ADMIN", Number = 42 },
            new Rank () { RankName = "Assistant VP", Abbreviation = "AVP", Number = 43 },
            new Rank () { RankName = "Department VP", Abbreviation = "VP", Number = 44 },
            new Rank () { RankName = "Chief Operation Officer", Abbreviation = "COO", Number = 45 },
            new Rank () { RankName = "Chief Financial Officer", Abbreviation = "CFO", Number = 46 },
            new Rank () { RankName = "CEO", Abbreviation = "CEO", Number = 47 },
            new Rank () { RankName = "President", Abbreviation = "President", Number = 48 }
        };
